...
public class Default {
    ...
    static final String PARAM_PAGE_NUMBER = "pageNumber";
    static final String PARAM_PAGE_SIZE = "pageSize";
    static final String PARAM_LANG = "lang";
    static final String PARAM_QUESTION_CREATE = "questionCreate";
    static final String PARAM_QUESTION_UPDATE = "questionUpdate";
    static final String PARAM_QUESTION_DELETE = "questionDelete";
    ...
    static final String INPUT_ROLE = "role";
    static final String INPUT_GAME_STATE = "gameState";
    static final String INPUT_NEXT_QUESTION_ID = "nextQuestionId";
    static final String INPUT_TEXT = "text";
    static final String INPUT_ANSWER = "answer";
    static final String INPUT_SIGN_IN = "signIn";
    ...
    static final String FORM_VALIDATION = "form.validation-1.0.js";
    static final String DEFAULT_AVATAR = "no_avatar.jpg";
    static final String DEFAULT_IMAGE = "no_image.jpg";
    ...
    static final String ATTR_GAME = "game";
    ...
    static final String ATTR_OPEN_QUESTS = "openQuests";
    static final String ATTR_AUTHORS = "authors";
    static final String ATTR_PAGE_SIZE = "pageSize";
    ...
    static final String EMPTY_PASSWORD = "Empty passwords are not supported.";
