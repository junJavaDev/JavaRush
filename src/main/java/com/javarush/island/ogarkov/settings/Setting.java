...
public class Setting {
    ...
    public static final int ISLAND_COLS = 22;
    ...
    public static final int CARNIVORE_PROPABILITY = 2;
    public static final int HERBIVORE_PROPABILITY = 60;
    public static final int PLANT_PROPABILITY = 300;
