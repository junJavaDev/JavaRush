                            ...
                            <c:forEach var="question" items="${requestScope.quest.questions}" varStatus="loop">
                                <tr ${question.id == requestScope.question.id
                                    ...
                                    <td><a class="link-primary text-decoration-none"
                                           href="javascript:postToUrl('${rootPath}${s.questEdit}?${s.paramId}=${param.id}', {'${s.paramQuestionDelete}':'${question.id}'});">
                                            ${langTableDelete}
                                    </a>
                                    </td>
                                </tr>
            ...
            <div class="card my-3 quest-editor">
                <div class="my-custom-scrollbar">
                    ...
                    <form class="needs-validation mx-3" novalidate
                          action="${rootPath}${s.questEdit}?${s.paramId}=${param.id}&${s.paramQuestionIndex}=${param.questionIndex}"
                                            ...
                                            <table class="table table-sm mb-0 text-sm">
                                                ...
                                                <c:forEach var="entry" items="${requestScope.answers}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="link-primary text-decoration-none"
                                                               href="javascript:postToUrl('${rootPath}${s.questEdit}?${s.paramId}=${param.id}', {'${s.paramAnswerDelete}':'${entry.key.id}'});">
                                                                ${langTableDelete}
                                                        </a>
                                                        </td>
                                                    </tr>
