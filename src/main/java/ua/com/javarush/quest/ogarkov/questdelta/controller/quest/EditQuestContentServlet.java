...
@WebServlet(name = "editQuestContent", value = EDIT_QUEST_CONTENT)
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (optUser.isPresent() && optQuest.isPresent()) {
            ...
            if (Objects.equals(user.getId(), quest.getAuthorId()) || user.getRole() == Role.ADMIN) {
                long questionIndex = ReqParser.getLong(req, "questionIndex");
...
//                    String nextQuestionCountPrefix = (1 + nextQuestionIndex) + " ";
                ...
                Jsp.forward(req, resp, "/quest/editQuestContent");
            }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        if (optQuest.isPresent()) {
            ...
            if (questionDeleteParam != null) {
                ...
                Jsp.redirect(req, resp, EDIT_QUEST_CONTENT + "?id=" + questId + "&" + PARAM_QUESTION_INDEX + "=" + (quest.getQuestions().size() - 1));
                return;
                //------------------- Создание вопроса ----------------------//
                //------------------- Создание ответа ----------------------//
                ...
                Jsp.redirect(req, resp, EDIT_QUESTS);
                return;
            }
            Jsp.redirect(req, resp, EDIT_QUEST_CONTENT + "?id=" + questId + "&" + PARAM_QUESTION_INDEX + "=" + questionIndex);
        }
